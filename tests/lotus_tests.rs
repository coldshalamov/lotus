...
use lotus::metrics::{
    ...
    elias_gamma_encode, leb128_bits, leb128_decode, leb128_encode, summarize_uniform_domain,
    vlq_bits, vlq_decode, vlq_encode, UniformDomain,
};
use lotus::{
...
fn exact_uniform_u64_regression_is_not_sampled() {
    ...
    assert_eq!(
        dense.total_bits,
        Some(1_300_495_457_194_375_872_390)
    );
    assert_eq!(
